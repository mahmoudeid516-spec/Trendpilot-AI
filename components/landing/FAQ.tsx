    ...
    <section id="faq" className="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8">
      <ScrollReveal>
        <div className="text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[var(--accent-ai)]">Questions</p>
      ...
      <div className="mt-10 space-y-3">
        {FAQS.map((faq, i) => (
          <ScrollReveal key={faq.question} delayMs={i * 50}>
            <details className="group rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-card)] px-5 py-4 transition-colors open:border-[var(--accent-ai)]/25 open:pb-5">
