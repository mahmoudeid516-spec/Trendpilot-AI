...
--
-- This migration is fully independent of products/RLS
-- (20260808172600_products_user_isolation.sql) -- it does not touch the
-- products table, its columns, or its policies in any way.
--
